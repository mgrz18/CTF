...
## SoluciÛn
El pptm sabemos que a final de cuentas es un zip con informaci√≥n del documento, as√≠ se ha manejado Microsoft a lo largo de los a√±os.
...
Este archivo tiene un cÛdigo con espacios, el siguiente comando elimina los espacios y adem·s decodifica de base64
