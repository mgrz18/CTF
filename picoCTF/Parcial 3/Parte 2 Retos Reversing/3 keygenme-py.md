...
## Solución
El código que nos proporcionan se vería de la siguiente forma:
```python
#============================================================================#
#============================ARCANE CALCULATOR===============================#
#============================================================================#
...
Como podemos observar, hay una parte del código que se encarga de verificar si la llave coincide con los valores que el código tiene, por lo que nosotros directamente podemos hacer que imprima los valores que tiene el código en vez de compararlos. Esto nos va a mostrar la parte que falta de la bandera. El código que directamente imprime los valores se vería de la siguiente manera:
```python
import hashlib
...
```
En mi caso me tocó usar el usuario FRASER como test trial. Después de ejecutar el código, este me mostraría la parte restante de la bandera, concluyendo así el reto.
